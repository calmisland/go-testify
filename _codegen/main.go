...
var (
	pkg       = flag.String("assert-path", "github.com/calmisland/go-testify/assert", "Path to the assert package")
...
var headerTemplate = `/*
* CODE GENERATED AUTOMATICALLY WITH github.com/calmisland/go-testify/_codegen
